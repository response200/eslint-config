...
Feature: TypeScript rules
  ...
  Scenario: @typescript-eslint/no-unsafe-call rule
    ...
    And line 6 should contain error "Unsafe call of a(n) `any` typed value."
    And line 7 should contain error "Unsafe call of a(n) `error` type typed value."
  ...
  Scenario: @typescript-eslint/no-unsafe-return rule
    ...
    When file is linted
    Then file should contain 4 lint errors
    And line 8 should contain error "Unsafe return of a value of type `any`."
    And line 12 should contain error "Unsafe return of a value of type `any`."
    And line 20 should contain error "Unsafe return of a value of type `any[]`."
    And line 24 should contain error "Unsafe return of a value of type `any[]`."
